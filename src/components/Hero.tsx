...
const Hero = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // Mantendo sua funcionalidade original de autenticação
    setTimeout(() => {
  ...
  return (
    <section className="relative min-h-screen w-full flex flex-col items-center justify-center px-4 font-sans">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        {/* Camada para garantir que o seu card original continue legível */}
        <div className="absolute inset-0 bg-black/20"></div>
      </div>

      {/* TODO O SEU CONTEÚDO ORIGINAL ABAIXO (Envolvido em uma div com z-10) */}
      <div className="relative z-10 w-full max-w-md flex flex-col items-center">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <div className="w-12 h-[3px] bg-[#8b1d22] mt-1"></div>
        </div>

        <div className="relative w-full max-w-md">
          {/* CARD DE LOGIN ESTILO MARICÁ */}
          <div className="bg-white rounded-[2.5rem] p-10 md:p-12 shadow-2xl border border-gray-100">
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              {/* Botão de Entrar - Padrão Azul Celeste */}
              <button
                type="submit"
                disabled={loading}
